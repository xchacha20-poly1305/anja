...
// Code generated by 'anja help documentation doc.go'. DO NOT EDIT.
...
To install:
	...
	$ go install github.com/xchacha20-poly1305/anja/cmd/anja@latest
	$ anja init
...
Usage:
	...
	anja command [arguments]

Commands:

	bind        build a library for Android and iOS
	build       compile android APK and iOS app
	clean       remove object files and cached anja files
	init        build OpenAL for Android
	install     compile android APK and install on device
	version     print version

Use 'anja help [command]' for more information about that command.

# Build a library for Android and iOS

Usage:

	anja bind [-target android|ios|iossimulator|macos|maccatalyst] [-bootclasspath <path>] [-classpath <path>] [-o output] [build flags] [package]
...
Usage:
	...
	anja build [-target android|ios|iossimulator|macos|maccatalyst] [-o output] [-bundleid bundleID] [build flags] [package]
...
# Remove object files and cached anja files
...
Usage:
	...
	anja install [-target android] [build flags] [package]
...
*/
package main // import "github.com/xchacha20-poly1305/anja/cmd/anja"
